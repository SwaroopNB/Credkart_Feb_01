...
def browser_setup(request): # function
    ...
    request.cls.driver = driver # attaching driver to main class # ---New
    yield driver
    print("\nBrowser Closed")
    driver.quit()
...
## for to change HTML report
def pytest_metadata(metadata):
    # add metadata
    metadata["Project Name"] = "Credkart Automation"
    metadata["Environment"] = "QA Environment"
    metadata["Test_Name"] = "Credence"
    # delete metadata which already present in HTML file
